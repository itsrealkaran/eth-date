    ...
    const errorCallback = (error) => {
      ...
      switch (error.code) {
        ...
        case error.POSITION_UNAVAILABLE:
          ...
          suggestion =
            "Desktop computers may not have GPS. Try using a mobile device or enable location services.";
          break;
        case error.TIMEOUT:
          errorMessage = "Location request timed out";
          suggestion =
            "Location services may be slow. Try refreshing the page or check your internet connection.";
          break;
      }

      // For desktop users, provide additional context
      const isDesktop =
        !("ontouchstart" in window) && !navigator.userAgentData?.mobile;
      if (isDesktop && error.code === error.POSITION_UNAVAILABLE) {
        suggestion =
          "Desktop computers typically don't have GPS. For the best experience, use a mobile device with location services enabled.";
      }
